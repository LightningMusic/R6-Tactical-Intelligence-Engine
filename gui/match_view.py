...
class MatchView(QWidget):
    ...
    MAP_SITES: dict[str, list[str]] = {
        "Bank":               ["1F Teller's Office, 1F Archives", "2F Executive Lounge, 2F CEO Office", "B Lockers, B CCTV", "1F Staff Room, 1F Open Area"],
        "Border":             ["2F Armory Lockers, 2F Archives", "1F Customs Inspections, 1F Supply Room", "1F Ventilation Room, 1F Workshop", "1F Bathroom, 1F Tellers"],
        "Chalet":             ["B Wine Cellar, B Snowmobile Garage", "1F Kitchen, 1F Dining Room", "2F Master Bedroom, 2F Office", "1F Bar, 1F Gaming Room"],
        "Clubhouse":          ["B Church, B Arsenal Room", "1F Bar, 1F Stage", "2F CCTV Room, 2F Cash Room", "2F Gym, 2F Bedroom"],
        "Coastline":          ["1F Kitchen, 1F Service Entrance", "1F Blue Bar, 1F Sunrise Bar", "2F Penthouse, 2F Theater", "2F Hookah Lounge, 2F Billiards Room"],
        "Consulate":          ["B Cafeteria, B Garage", "1F Exposition Room, 1F Piano Room", "2F Consul Office, 2F Meeting Room", "1F Tellers, B Servers"],
        "Emerald Plains":     ["1F Dining, 1F Kitchen", "1F Bar, 1F Lounge", "2F Administration, 2F CEO Office", "2F Private Gallery, 2F Meeting"],
        "Favela":             ["1F Blue Bedroom, 1F Green Apartment", "2F Storage, 2F Coin Room", "2F Coin Farm, 2F Bunks", "1F Pink Apartment, 1F Pink Kitchen"],
        "Fortress":           ["1F Hammam, 1F Sitting Room", "1F Waiting Room, 1F Cafeteria", "2F Bathroom, 2F Commander's Office", "2F Dormitory, 2F Games Room"],
        "House":              ["B Gym, B Garage", "1F TV Room, 1F Music Room", "2F Master Bedroom, 2F Car Room", "2F Car Room, 2F Pink Room"],
        "Kafe Dostoyevsky":   ["1F Kitchen Service, 1F Kitchen Cooking", "2F Fireplace Hall, 2F Reading Room", "2F Fireplace Hall, 2F Mining Room", "3F Cocktail Lounge, 3F Bar"],
        "Kanal":              ["B1 Supply Room, B1 Kayaks", "1F Coast Guard Station, 1F Lounge", "1F Map Room, 1F Security Room", "2F Radar Room, 2F Server Room"],
        "Lair":               ["B Lab, B Lab Support", "1F Bunks, 1F Briefing", "1F Weapon Maintenance, 1F Armory", "2F Master Office, 2F R6 Room"],
        "Nighthaven Labs":    ["B Assembly, B Tank", "1F Kitchen, 1F Cafeteria", "2F Command Center, 2F Servers", "1F Storage, 1F Control Room"],
        "Oregon":             ["B Laundry Room, B Supply Room", "1F Kitchen, 1F Dining Hall", "2F Kids' Dorms, 2F Dorms Main Hall", "1F Meeting Hall, 1F Kitchen"],
        "Outback":            ["1F Mechanic Shop, 1F Kitchen", "2F Laundry, 2F Piano Room", "2F Party Room, 2F Office", "1F Green Bedroom, 1F Red Bedroom"],
        "Presidential Plane": ["1F Luggage Hold, 1F Cargo Hold", "2F Executive Office, 2F Meeting Room", "2F Staff Section, 2F Executive Bedroom"],
        "Skyscraper":         ["1F Kitchen, 1F BBQ", "1F Bedroom, 1F Bathroom", "2F Karaoke, 2F Tea Room", "2F Exhibition Room, 2F Office"],
        "Stadium Bravo":      ["1F Service, 1F Kitchen", "1F Showers, 1F Server", "2F Penthouse, 2F VIP Lounge", "2F Armory Lockers, 2F Archives"],
        "Theme Park":         ["1F Armory, 1F Throne Room", "1F Lab, 1F Storage", "2F Initiation Room, 2F Office", "2F Bunk, 2F Day Care"],
        "Tower":              ["1F Restaurant, 1F Bird Room", "1F Bar, 1F Tea Room", "2F Media Center, 2F Exhibit Room", "2F Gift Shop, 2F Lantern Room"],
        "Villa":              ["1F Dining Room, 1F Kitchen", "1F Living Room, 1F Library", "2F Aviator Room, 2F Games Room", "2F Trophy Room, 2F Statuary Room"],
        "Yacht":              ["1F Server Room, 1F Engine Storage", "2F Engine Control, 2F Kitchen", "2F Staff Dormitory, 2F Cafeteria", "4F Maps Room, 4F Cockpit"],
    }
